...
const Sidebar: React.FC = React.memo(() => {
  ...
  const navigation = [
    { name: 'recursos', href: '/obra', icon: Home },
    { name: 'Planilla', href: '/obra', icon: Calculator },
    { name: 'Equipos', href: '/obra', icon: Package },
    { name: 'Personal', href: '/obra', icon: Users },
    { name: 'Configuración', href: '/obra', icon: Settings },
  ];
