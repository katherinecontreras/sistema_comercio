...
import { X, Download, Plus, Trash2, Check } from 'lucide-react';
import { AtributoBase } from '@/store/atributo';

interface ExcelAttributeModalInlineProps {
  onClose: () => void;
...
const ExcelAttributeModalInline: React.FC<ExcelAttributeModalInlineProps> = ({ onClose, onConfirm }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-semibold text-white">Seleccionar Atributos para Excel</h3>
          <p className="text-slate-400">Selecciona los atributos que quieres incluir en la plantilla Excel</p>
        </div>
        <Button
          onClick={onClose}
          variant="outline"
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">
                {atributosSeleccionados.size > 0 
                  ? 'Se generará una plantilla Excel con los atributos seleccionados'
                  : 'Selecciona al menos un atributo para generar la plantilla'
                }
              </p>
            </div>
      ...
      <div className="flex justify-end space-x-2">
        ...
        >
          ...
          Generar Excel ({atributosSeleccionados.size})
        </Button>
      </div>
    </div>
  );
...
export default ExcelAttributeModalInline;
