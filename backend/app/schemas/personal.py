...
class PersonalBase(BaseModel):
    ...
    neto_mensual_con_vianda_xdia: float
    ...
    examen_medico_y_capacitacion: float
...
class PersonalUpdate(BaseModel):
    ...
    neto_mensual_con_vianda_xdia: Optional[float] = None
    ...
    examen_medico_y_capacitacion: Optional[float] = None
